...
public class BagOfWordsExtractor {
	...
	private static final String DEFAULT_STOP_WORD_LIST_FILE = "mu/ark/nlp/supersense/stopWordList.txt";
	
	public BagOfWordsExtractor(Properties props){
		this.stopWordList = loadStopList(props.getProperty("stopWordList", DEFAULT_STOP_WORD_LIST_FILE));
	}
	/*
