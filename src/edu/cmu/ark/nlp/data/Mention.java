...
import edu.cmu.ark.nlp.ace.AceDocument;
...
public class Mention implements Serializable{
	...
	public String neType() {
		...
		Tree head = node.headTerminal(ArkParser.getInstance().getHeadFinder()); 
	...
	public Tree getHeadNode(){
		...
		Tree res = node.headTerminal(ArkParser.getInstance().getHeadFinder());
		...
		if(yield.equals("'s")){
			...
			res = copy.headTerminal(ArkParser.getInstance().getHeadFinder());
		}
		return res;
	}
