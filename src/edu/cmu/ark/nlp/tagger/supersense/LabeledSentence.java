...
public class LabeledSentence {
	...
	private List<String> stems; // stems aligned to the words (original tokens
								// used if no stem known in WordNet)
	private List<String> posLabels; // part of speech labels
	private List<String> trueLabels; // true supersense labels (if available
										// from training/test data)
	private List<String> predictions; // predictions made by the system
	private List<String> mostFrequentSenses; // most frequent sense labels using
												// WordNet info
